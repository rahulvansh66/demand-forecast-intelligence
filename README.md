...
Traditional sampling methods rank items by "quality" (volume × availability) and select the "best" items, creating severe bias toward high-volume, stable products. This makes POC validation overly optimistic since real-world forecasting challenges come from intermittent, sparse, and irregular demand patterns.
...
```json
{
  ...
  "behavioral_diversity": {
    ...
    "intermittency_patterns": {"sparse": 0.18, "intermittent": 0.32, "regular": 0.50},
    "lifecycle_stages": {"early": 0.15, "mature": 0.70, "late": 0.15}
  },
  "geographic_coverage": {
