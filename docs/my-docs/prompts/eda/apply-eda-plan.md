...
Print all findings, including calculations, statistics, scores, and statistical test results, in eda_report.md in a clear and readable format. The goal is for eda_report.md to provide all mathematical facts about the data so I can review them later before planning preprocessing or model building.
