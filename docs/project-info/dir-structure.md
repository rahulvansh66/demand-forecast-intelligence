...
- `src/`
  ...
  - `demand_forecast_intelligence/`
    ...
    - `preprocessing/`
      - Data cleaning, feature engineering, and preparation before modeling.
      - Converts raw or interim data into consistent model-ready structures.
      - Subdirectories are listed in the recommended development order.
      - `cleaners/`
      ...
      - `features/`
        ...
        - `common/`
          - Features used by multiple modeling use cases.
          - Includes generic derived features that are not specific to one model type.
        - `forecasting/`
          - Contain forecasting-specific features
        - `segmentation/`
          - Contain segmentation-specific features
      - `splitters/`
        - Contains train/test and time-based split logic for forecasting and segmentation dataset.
        - Ensures forecasting data is split correctly without time leakage.
      - `pipelines/`
        - Defines reusable preprocessing workflows.
        - Combines the previously developed cleaners, transformers, feature generators, and splitters into repeatable steps.
    ### 3.4 Domain Modules
    - `model_development/`
      - Business-specific machine learning modules.
      - Separates forecasting and segmentation concerns.
      #### 3.4.1 Forecasting Domain
      - `forecasting/`
    ...
    ### 3.5 GenAI Insights Module
    - `genai_business_insights/`
      - GenAI business insight generation module.
    ...
    ### 3.6 Pipeline Module
    - `pipelines/`
      - End-to-end orchestration across model use cases.
